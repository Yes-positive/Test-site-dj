...
from Applications.mixins import UserIsOwnerMixin
from Applications.forms import TaskForm, TaskFilterForm, CommentForm
...
class CommentDeleteView(LoginRequiredMixin, DeleteView):
    ...
    def get_queryset(self):
        ...
        return quryset.filter(author=self.request.user)
